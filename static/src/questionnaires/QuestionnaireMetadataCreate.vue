<template>
  <div>
    <div class="card-header pl-0">
      <button type="button" class="btn btn-success mr-2" style="cursor: Text;">Etape 1/4: Créer le questionnaire<i class="fa fa-angle-double-right ml-4"></i></button>
      <button type="button" class="btn btn-outline-primary mr-2" style="cursor: Text;" disabled>Etape 2/4: Ajouter des questions<i class="fa fa-angle-double-right ml-4"></button>
