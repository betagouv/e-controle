<template>
  <div>
      <div class="card-header pl-0">
        ...
        <button type="button" class="btn btn-sm btn-success mr-2" style="cursor: Text;" disabled>Etape 2/3: Ajouter des questions<i class="fa fa-angle-double-right ml-4"></button>
        <button type="button" class="btn btn-sm btn-success mr-2" style="cursor: Text;">Etape 3/3: Aperçu avant publication<i class="fa fe fe-check ml-4"></button>
      </div>
    <div class="preview">
