...
def copy_all_the_things(existing_question_id, existing_question_file_id):
    """
...
existing_question_id = 107
existing_question_file_id = 24
copy_all_the_things(existing_question_id, existing_question_file_id)
