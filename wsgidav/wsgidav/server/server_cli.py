...
"""
    ...
    parser.add_argument(
        "--auth",
        choices=("anonymous", "nt", "pam-login", "cc-login"),
...
def _init_config():
    ...
    if auth == "anonymous":
        ...
        auth_conf.update(
            {
                "domain_controller": "wsgidav.dc.pam_dc.CCDomainController",
                "accept_basic": True,
                "accept_digest": False,
                "default_to_digest": False,
            }
    ...
    # print(config)
        ...
        auth_conf.update(
            {
                "domain_controller": "wsgidav.dc.ccomptes_dc.CCDomainController",
                "accept_basic": True,
                "accept_digest": False,
                "default_to_digest": False,
            }
